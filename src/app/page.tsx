                    ...
                    <div className="flex items-center flex-col justify-center h-screen">
                        <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-4xl">
                            ...
                            <div className="flex items-center justify-center mt-6 gap-x-6">
                                <a href="https://x.com/kavosyt/status/1727342704948855049?s=46" className="text-xs font-semibold leading-7 uppercase font-mono text-white hover:underline">Wtf? <span aria-hidden="true">→</span></a>
                            </div>
                        </div>
                    </div>
                </div>

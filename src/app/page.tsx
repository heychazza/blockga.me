                ...
                <div className="px-6 lg:px-8">
                    <div className="flex items-center flex-col justify-center h-screen">
                        <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-4xl">
                            ...
                            <h1 className="my-3 lg:my-5 text-2xl lg:text-4xl font-bold font-mono tracking-tight text-center text-black capitalize leading-normal sm:leading-tight">Broke Boy Cookies</h1>
                            ...
                            <div className="flex items-center justify-center mt-6 gap-x-6">
                                <a href="https://x.com/kavosyt/status/1727342704948855049?s=46" className="text-xs font-semibold leading-7 uppercase text-gray-900 hover:underline"> Context? <span aria-hidden="true">→</span></a>
                            </div>
                        </div>
                    </div>
                </div>
